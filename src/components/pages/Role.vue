<template>
    <div>
        ...
        <div style="background-color: #fff;padding: 10px ;margin-top: 10px;position: absolute;top: 25px;bottom: 20px;right: 10px;left: 10px;">
            <div>
                <el-input v-model="filters.name" placeholder="角色名称" style="width: 215px;"></el-input>
        ...
        <el-dialog :title="addForm.id ? '编辑角色' : '新增角色'" :visible.sync="dialogAddVisible" :close-on-click-modal="false" width="30%" :before-close="addRoleDialogHide">
        ...
        <!--功能绑定界面-->
        <el-dialog width="600px" title="绑定功能"  :visible.sync="bingFunVisible" :before-close="addRoleDialogHide" :close-on-click-modal="false" >
