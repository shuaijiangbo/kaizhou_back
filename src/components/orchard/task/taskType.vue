<template>
    <div>
        ...
        <div style="background-color: #fff;padding: 10px ;margin-top: 10px;position: absolute;top: 54px;bottom: 20px;right: 10px;left: 10px;">
            <div>
                <el-input v-model="filters.name" placeholder="请输入任务" style="width: 215px;"></el-input>
        ...
        <el-dialog  :title="addForm.id ? '编辑任务类型' : '新增任务类型'" :visible.sync="dialogAddVisible" :close-on-click-modal="false" width="50%" :before-close="addRoleDialogHide">
