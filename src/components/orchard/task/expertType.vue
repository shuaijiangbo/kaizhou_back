<template>
  <div>
    ...
    <el-dialog  :title="addForm.id ? '编辑专家信息类型' : '新增专家信息类型'" :visible.sync="dialogAddVisible" :close-on-click-modal="false" width="50%" :before-close="addRoleDialogHide">
